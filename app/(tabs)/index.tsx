...
export default function HomeScreen() {
  ...
  const saveImageToAppDirectory = async () => {
    try {
      ...
      const cleanBase64 = overlayImages[currentImageIndex].split(",")[1];
          ...
          <>
            {faceShape && (
              <Animatable.Text
                ...
                style={styles.result}
              >
                Detected Face Shape: {faceShape.charAt(0).toUpperCase() + faceShape.slice(1)}
              </Animatable.Text>
            )}
            {/* <Animatable.Image
              animation="fadeInUp"
              ...
              style={styles.image}
            /> */}
            <ImageGallery overlayImages={overlayImages}  onIndexChange={setCurrentImageIndex}  />
